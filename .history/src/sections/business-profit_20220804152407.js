...
const data = {
  ...
  btnName: 'Te gustaría ver como funciona? Visitá la demo!',
  btnURL: 'https://atumesa.uy/demo/',
  points: [
    {
    ...
    {
      icon: <IoIosCheckmarkCircle />,
      text: 'Tus clientes pueden elegir el metodo de pago, en efectivo o con tarjetas de debito o credito mediante tus POS al momento de la entrega.',
    },
    {
      icon: <IoIosCheckmarkCircle />,
      text: 'Web 100% responsive, adaptable para telefonos moviles asi como tambien tablets y computadoras.',
    },
  ],
};
